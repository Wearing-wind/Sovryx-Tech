...
function buildNav(activePage) {
  ...
  <nav>
    <a href="index.html" class="nav-brand">
      <img src="https://sovryxtech.com.np/logo.png" alt="Sovryx Tech" class="nav-logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
      <div class="nav-brand-logo" style="display:none;">ST</div>
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          <a href="index.html" class="nav-brand" style="text-decoration:none;">
            <div class="nav-brand-logo">ST</div>
            <div class="nav-brand-text">
